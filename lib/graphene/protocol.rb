...
module Graphene
  module Protocol
    ...
    # autoload :TxIn,    'graphene/protocol/txin'
    # autoload :TxOut,   'graphene/protocol/txout'
    # autoload :Tx,      'graphene/protocol/tx'
    # autoload :Block,   'graphene/protocol/block'
    # autoload :Addr,    'graphene/protocol/address'
    # autoload :Alert,   'graphene/protocol/alert'
    # autoload :Reject,  'graphene/protocol/reject'
    # autoload :Version, 'graphene/protocol/version'
    # autoload :AuxPow,  'graphene/protocol/aux_pow'
    #
    # autoload :Handler, 'graphene/protocol/handler'
    # autoload :Parser,  'graphene/protocol/parser'
    ...
    # GrapheneQT has later added even more compact format called CVarInt to use in its local block storage. CVarInt is not implemented here.
    ...
    def self.pkt(command, payload)
      ...
      pkt << Graphene.network[:magic_head].force_encoding(BINARY) << cmd.force_encoding(BINARY) << length << checksum << payload.force_encoding(BINARY)
    end
    ...
    def self.version_pkt(from_id, from=nil, to=nil, last_block=nil, time=nil, user_agent=nil, version=nil)
      opts = if from_id.is_a?(Hash)
        ...
        STDERR.puts "Graphene::Protocol.version_pkt - API deprecated. please change it soon.."
        {
